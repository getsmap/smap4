...
var config = {
	...
	//resolutions : [50.800128,33.866752,25.400064,16.933376,12.700032,8.466688,4.233344,2.116672,1.058336,0.529168,0.26458483,0.132292415], // EPSG:3008
	...
	//defaultWebParams : "defaultParam=5",
		...
		overlays : [
						...
						
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/kvarter.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_sum_kvarter_p",
				category : ["ADMINISTRATIV INDELNING"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${name}"],
				params : {
					sld: "http://sbkvmgeoserver.malmo.se/sld/polygon.xml",
				...
				popup :
					...
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</a></div>",
				selectable : true, getFeatureInfo: {geometryName: "geom"},
				geomType : 'area',
				startVisible : false,
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/kvarterhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/kvarter.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/delomraden.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_delomrade_p",
				category : ["ADMINISTRATIV INDELNING"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/delomradenhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/Administrativindelning/delomraden.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
						...
						
			{
				...
				name: "sma_stadsdel_p",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/stadsdelar.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_stadsdel_p",
				category : ["ADMINISTRATIV INDELNING"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/stadsdelarhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/stadsdelar.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/stadsdelar.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_stadomraden_p",
				category : ["ADMINISTRATIV INDELNING"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${sdfname}"],				
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/stadsomradehoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/stadsomrade.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/stadsdelar.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_forsamling_p",
				category : ["ADMINISTRATIV INDELNING"],
				displayInLayerSwitcher: true,
				//URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/nyckelkodsomraden.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_nyckelkodsomraden_p",
				category : ["ADMINISTRATIV INDELNING"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/nyckelkodsomradenhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/nyckelkodsomraden.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/adresser.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=adresser",
				category : ["ADMINISTRATIV INDELNING"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/administrativindelning/adresserhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/administrativindelning/adresser.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
						        	...
						        	symbolizer: {
								    	//graphicWidth: 40,
										//graphicHeigth: 40,
										//externalGraphic: 'http://sbkvmgeoserver.malmo.se/bilder/administrativindelning/select.png'
										externalGraphic: 'http://sbkvmgeoserver.malmo.se/bilder/Generell_select/kvadrat_medium_turkos.png'
							        }
						        }),
						        new OpenLayers.Rule({
						        	elseFilter: true,
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/befolkning/befolkning100.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_befolkning_p100",
				category : ["BEFOLKNING"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/befolkning/befolkninghoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/befolkning/befolkning.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/befolkning/befolkning500.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_befolkning_p500",
				category : ["BEFOLKNING"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${sum_km}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/befolkning/befolkninghoover500.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/befolkning/befolkning500.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/fastigheter.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_sum_fastyta_p",
				...
				params : {
					layers: "malmows:SMA_TRAKT_TEXT_P,malmows:3DFastigheterGroup,malmows:SMA_SUM_FASTYTA_P",
					// layers: "malmows:SMA_TRAKT_P,malmows:3DFastigheterGroup,malmows:SMA_SUM_FASTYTA_P",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					...
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/asp/fir/fir_sok.asp?FNR=${fnr}' target='_blank'>Visa information</a></div>" +		
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/administrativindelning/fastigheterhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:SMA_SUM_FASTYTA_P&version=1.1.1&format=image/png&rule=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Baskarta/fastigheter.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_sum_fastyta_p",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Fastighetskarta"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${fastighet}"],
				params : {
					layers: "malmows:3DFastigheterGroup,malmows:SMA_SUM_FASTYTA_P_EJ_TEXT",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
...

			{
				...
				name: "granspunkt",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Baskarta/granspunkt.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=granspunkt",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Fastighetskarta"],
				displayInLayerSwitcher: true,
				...
				report: {
					IDattribute: "pnamn",
					linkURL: "http://sbkvmas2.sbkmalmo.local/git/select/select.aspx?layer=fixpunkt&object="
				},
				params : {
				...
				popup :
					...
					"<br>" +
					"<div class='popup-text1'><a class='popup-text1' href='http://sbkvmas2.sbkmalmo.local/git/punktDB/stomnat.aspx?pnr=${pnamn}' target='_blank'>Visa punktinformation</a></div>" +
					"<div class='popup-text1'><a class='popup-text1' href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</a></div>" +
					"<div class='popup-text1'><a href='http://sbkvmgeoserver.malmo.se/cyclomedia/index.html?posx=${easting}&posy=${northing}' target='_blank'>Visa gatuvy</div>",
				selectable : true, getFeatureInfo: {geometryName: "geom"},
				geomType : 'area',
				startVisible : false,
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/baskarta/granspunkthoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/baskarta/granspunkt.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
						        	...
						        	// if a feature matches the above filter, use this style
						        	symbolizer: {
								    	externalGraphic: 'http://sbkvmgeoserver.malmo.se/bilder/Generell_select/cirkel_medium_turkos.png'
									}
						        }),
						        new OpenLayers.Rule({
						        	elseFilter: true,
			...
			{
				displayName : 'Ideal traktindelning',
				name: "sma_ideal_traktindelning_p",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/fastigheter.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_trakter_ideala_p",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Fastighetskarta"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				// URL: "http://kartor.malmo.se/geoserver/wms?",
				...
				params : {
					layers: "malmows:SMA_TRAKTER_IDEALA_P",
					// layers: "malmows:SMA_TRAKT_P,malmows:3DFastigheterGroup,malmows:SMA_SUM_FASTYTA_P",
					format: "image/png",
					transparent: "true"
				}, 
				...
				popup :
					"<div class='popup-header1'>Ideal trakt</div>" +
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:SMA_TRAKTER_IDEALA_P&version=1.1.1&format=image/png&rule=5"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:SMA_TRAKTER_IDEALA_P&version=1.1.1&format=image/png&rule=5"}
				}
			},

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Rattigheter/gemensamhetsanlaggningar.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_gemensamhetsanlaggningar_p",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Fastighetskarta"],
				displayInLayerSwitcher: true,
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/Rattigheter/GAhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/Rattigheter/gemensamhetsanlaggningar.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Rattigheter/ledningsratt.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_ledningsratt_p",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Fastighetskarta"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/Rattigheter/ledningsratthoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/Rattigheter/ledningsratt.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "sma_servitut_p",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Rattigheter/servitut.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_servitut_p",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Fastighetskarta"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${akt_lopnr}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/Rattigheter/servituthoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/Rattigheter/servitut.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	//symbolizer: {}
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Baskarta/byggnader.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_bk_byggnader",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Baskarta/byggnaderhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Baskarta/byggnader.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
								...
								
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Baskarta/vaglinjer.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_bk_vag_linjer",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Primärkarta"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				params : {
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Baskarta/vaghoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Baskarta/vag.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_ovriga_primkarta",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Primärkarta"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				params : {
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/baskarta/pk_ovriga_objekthoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/baskarta/pk_ovriga_objekthoover.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...
/*
			{
				...
				name: "sma_hojdkurvor_l",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/administrativindelning/fastigheter.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_hojdkurvor_l",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Primärkarta"],
				displayInLayerSwitcher: true,
				URL: "http://kartor.malmo.se/arcgis/services/sma_hojdkurvor_l/MapServer/WMSServer?",
				// URL: "http://kartor.malmo.se/geoserver/wms?",
				// report: {
					// IDattribute: "fnr",
					// linkURL: "http://localhost/?layer=fastighet&object="
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Baskarta/hojdkurvor_hoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Baskarta/hojdkurvor.png"}
				}
			},
*/			
			
			{
				...
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_arkiv_bladindelning_sr991330",
				category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Primärkarta"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Arkiv/bladindelningsr991330_hoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Arkiv/bladindelningsr991330.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			// {
				...
				// layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Baskarta/adresser.html",
				// dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=adresser",
				// category : ["FASTIGHETSKARTA & PRIMÄRKARTA","Primärkarta"],
				// displayInLayerSwitcher: true,
				// URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				// legend : {
					// hover: {
						// url: "http://sbkvmgeoserver.malmo.se/Bilder/baskarta/adresserhoover.png"
					// }
				// },		
				// copyright : [],
				// style: {
			...
			// {
				...
				// dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/baskarta/vitbakgrund.html",
				// dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=malmo_karta_vit_overlay",
				// category : ["GEODATA", "Baskarta"],
				// displayInLayerSwitcher: true,
				// URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
				...
				// legend : {
					// hover: {
						// url: "http://sbkvmgeoserver.malmo.se/bilder/baskarta/vitbakgrundhoover.png"
					// }
				// },		
				// copyright : [],
				// style: {
					// "default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/baskarta/vitbakgrund.png"}
				// }
			// },						

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/ajordbruk.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=miljotillsyn",
				...
				popup :
					...
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${ykordinat};${xkordinat}' target='_blank'>Visa snedbild</a></div>" +
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_AVFALL_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_AVFALL_PT&RULE=0"}
				}
			},
			
			{
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_DJUR_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_DJUR_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_ENSKILDA_AVLOPP_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_ENSKILDA_AVLOPP_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_FORSKOLA_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_FORSKOLA_PT&RULE=0"}
				}
		},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_HALSA_LOKALER_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_HALSA_LOKALER_PT&RULE=0"}
				}
			},			

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_KEMIKALIER_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_KEMIKALIER_PT&RULE=0"}
				}
			},
			
			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_KOLDMEDIA_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_KOLDMEDIA_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_KOLDMEDIA_OVRIGT_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_KOLDMEDIA_OVRIGT_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_LIVSMEDEL_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_LIVSMEDEL_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_LOKALER_OVRIGT_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_LOKALER_OVRIGT_PT&RULE=0"}
				}
			},
...

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_LAKEMEDEL_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_LAKEMEDEL_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_MILJOFARLIG_VERKSAMHET_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_MILJOFARLIG_VERKSAMHET_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_MILJOTILLSYN_OVRIGT_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_MILJOTILLSYN_OVRIGT_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_MOTORFORDON_INFRASTRUKTUR_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_MOTORFORDON_INFRASTRUKTUR_PT&RULE=0"}
				}
			},
			
			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_PCB_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_PCB_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_SKOLOR_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_SKOLOR_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_VATTEN_AVLOPP_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_VATTEN_AVLOPP_PT&RULE=0"}
				}
			},

			{
				...
				legend : {
				hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&WIDTH=80&HEIGHT=30&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_VARMEPUMP_PT&RULE=0"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?REQUEST=GetLegendGraphic&VERSION=1.1.1&FORMAT=image/png&LAYER=malmows:MILJO_MILJOREDA_ALLA_PT&STYLE=MILJOREDA_VARMEPUMP_PT&RULE=0"}
				}
			},
			...
			},		
			{
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver/bilder/miljo/legend_buller_text.png"
					}
				},	
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver/bilder/miljo/legend_buller_liten.png"}
				}
			},						
			...
			
		{
			...
			category : ["MILJÖ, RISK OCH SÄKERHET","Miljöövervakning"],
			displayInLayerSwitcher: true,
			URL: "http://kartor.malmo.se/arcgis/services/kvavedioxid/MapServer/WMSServer?",
			params : {
				layers: '0,1,2', 
				format: 'image/png',
				transparent: 'true',
			...
			copyright : [],
			style: {
				"default": {externalGraphic: "http://kartor.malmo.se/wwwroot_data/bilder/legender/mf/Legend_NO2karta.png"}			
			},
			legend : {
				hover: {
					url: "http://kartor.malmo.se/wwwroot_data/bilder/legender/mf/Legend_NO2karta.png"
				}
			}
		},
			{
				...
				name: "radon",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/miljo/radon.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=radon",
				category : ["MILJÖ, RISK OCH SÄKERHET","Miljöövervakning"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				params : {
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/miljo/radonhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/miljo/radon.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...
/*
			{
				...
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=miljo_luftfororening",
				category : ["MILJÖ"],
				displayInLayerSwitcher: true,
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/miljo/luftfororeningarhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/miljo/luftfororeningar.png"}
				}
			},						
						...
						
			{
				...
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=miljo_tagbuller",
				category : ["MILJÖ"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/miljo/tagbullerhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/miljo/tagbuller.png"}
				}
			},						
			
			{
				...
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=miljo_vagbuller",
				category : ["MILJÖ"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
...
*/
			...
			
			{
				...
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
					layers: "malmows:SBK_STRATEGI_NATURVARDSPLAN_P",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Info</div>" +
					"<div class='popup-text1'>${namn}</div><BR>" +
					"<div class='popup-text1'><a href='http://kartor.malmo.se/wwwroot_data/dokument/naturvardsplan/${url}' target='_blank'>Visa information</a></div>" ,
				blixtable : true, 
				selectable : true, 
				getFeatureInfo: {geometryName: "geom"},	
				geomType : 'polygon',
...

			{
				...
				name: "sbk_naturreservat_p",
				layerType : "wms",
				//dialogContent: "http://kartor.malmo.se/op_data_aug_2013/4_underlag/natur/naturreservat/html/naturreservat.htm",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naturreservat",
				category : ["NATUR, REKREATION MED MERA"],
				displayInLayerSwitcher: true,
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
					layers: "malmows:SBK_NATURRESERVAT_MALMO_P",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Naturreservat</div>" +
					"<div class='popup-text1'>${namn}</div>"+
					"<div class='popup-text1'>Status: ${beslstatus}</div>"+
				...
				legend : {
					hover: {
						url: "http://kartor.malmo.se/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:SBK_NATURRESERVAT_MALMO_P&version=1.1.1&format=image/png"
					}
				},	
				style: {
					"default": {externalGraphic: "http://kartor.malmo.se/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:SBK_NATURRESERVAT_MALMO_P&version=1.1.1&format=image/png&rule=gallande"}
				}
			},


			{
				displayName : 'Inventerade träd',
				name: "invent_trad",
				layerType : "wms",
				// dialogContent: "http://kartor.malmo.se/op_data_aug_2013/4_underlag/natur/naturreservat/html/naturreservat.htm",
				category : ["NATUR, REKREATION MED MERA"],
...

			{
				...
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=geologi_borrhal",
				category : ["NATUR, REKREATION MED MERA"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/wms?",
				params : {
				...
				popup :
					...
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/asp/borrhal/geo_borrhal.asp?PUNKTNR=${punktnr}' target='_blank'>Visa information</a></div>",
				...
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/alla.png"}
				}
			},	
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/cfar.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				selectAttributes: ["${foretagsnamn}","${besoksadress}"],
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/allahoover.png"
					}
				},		
				copyright : [],
				style: {
			...
			
			{
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Ajordbrukhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Ajordbruk.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "bctillverkning",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/BCtillverkning.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/BCtillverkninghoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/BCtillverkning.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/deenergi.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/DEenergihoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/DEenergi.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/fbyggverksamhet.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Fbyggverksamhethoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Fbyggverksamhet.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/ghandel.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Ghandelhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Ghandel.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/htransport.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Htransporthoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Htransport.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/ihotell.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Ihotellhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Ihotell.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/jinformation.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Jinformationhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Jinformation.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/kfinans.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Kfinanshoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Kfinans.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/Lfastighetsverksamhet.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Lfastighetsverksamhethoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Lfastighetsverksamhet.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/Mjuridik.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				selectAttributes: ["${foretagsnamn}","${besoksadress}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Mjuridikhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Mjuridik.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/Nuthyrning.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Nuthyrninghoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Nuthyrning.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/Ooffentligsektor.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Ooffentligsektorhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Ooffentligsektor.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "putbildning",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/PUtbildning.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Putbildninghoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Putbildning.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/Qvard.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Qvardhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/Qvard.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/nk/RSKultur.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=naringsliv",
				category : ["NÄRINGSLIV"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/RSkulturhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/naringsliv/RSkultur.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			{
				displayName : 'Planuppdrag (PP)',
				name: "sbkplan_planprog_planuppd",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_pagaende_planprogram",
				category : ["PLANERA & BYGGA","Planera", "Pågående planprogram"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?",
				selectAttributes: ["${plan}"],
				params : {
					layers: "malmows:git_sbk_plan_planprog_planuppd_p",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					...
					"<div class='popup-text1'>Plannummer: ${dp_namn}</div>" +
					"<div class='popup-text1'>Diarienummer: ${diarienr}</div>" +
					"<div class='popup-text1'>Planhandläggare: ${planhandlaggare}</div>" +
					"<div class='popup-text1'>Planuppdrag: ${anmald_sbn}</div>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/editPlan.aspx?id=${objectid}' target='_blank'>Visa mer information</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/allaplaner.aspx' target='_blank'>Visa plankatalogen</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${dp_easting};${dp_northing}' target='_blank'>Visa snedbild</a></div>",
				selectable : true, getFeatureInfo: {geometryName: "geom"},
				geomType : 'area',
				startVisible : false,
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_planprog_planuppd_p&version=1.1.1&format=image/png&rule=6"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_planprog_planuppd_p&version=1.1.1&format=image/png&rule=6"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			{
				displayName : 'Samråd (PP)',
				name: "sbkplan_planprog_samrad",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_pagaende_planprogram",
				category : ["PLANERA & BYGGA","Planera", "Pågående planprogram"],
				displayInLayerSwitcher: true,
				...
				selectAttributes: ["${plan}"],
				params : {
					layers: "malmows:git_sbk_plan_planprog_samrad_p",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					...
					"<div class='popup-text1'>Planhandläggare: ${planhandlaggare}</div>" +
					"<div class='popup-text1'>Planuppdrag: ${anmald_sbn}</div>" +
					"<div class='popup-text1'>Samråd: ${samrad}</div>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/editPlan.aspx?id=${objectid}' target='_blank'>Visa mer information</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/allaplaner.aspx' target='_blank'>Visa plankatalogen</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${dp_easting};${dp_northing}' target='_blank'>Visa snedbild</a></div>",
				selectable : true, getFeatureInfo: {geometryName: "geom"},
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_planprog_samrad_p&version=1.1.1&format=image/png&rule=6"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_planprog_samrad_p&version=1.1.1&format=image/png&rule=6"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			{
				displayName : 'Planuppdrag',
				name: "sbkplan_anmald",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sbkplan_anmald",
				category : ["PLANERA & BYGGA","Planera", "Pågående detaljplan"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?",
				params : {
					layers: "malmows:git_sbk_plan_anmald_p", 
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Planuppdrag</div>" +
					"<div class='popup-text1'>Plannamn: ${plannamn}</div>" +
					"<div class='popup-text1'>plannr: ${dp_namn}</div>" +
					"<div class='popup-text1'>Anmäld: ${anmald_sbn}</div>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/editPlan.aspx?id=${objectid}' target='_blank'>Visa mer information</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/allaplaner.aspx' target='_blank'>Visa plankatalogen</a></div>"+
					"<div class='popup-text1'><a href='${url}' target='_blank'>Visa plandokumentation</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${dp_easting};${dp_northing}' target='_blank'>Visa snedbild</a></div>",						
				selectable : true, 
				getFeatureInfo: {geometryName: "geom"},
				geomType : 'point',
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_anmald_p&version=1.1.1&format=image/png&rule=6"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_anmald_p&version=1.1.1&format=image/png&rule=6"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				name: "sbkplan_samrad",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sbkplan_samrad",
				category : ["PLANERA & BYGGA","Planera", "Pågående detaljplan"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?",
				params : {
					layers: "malmows:git_sbk_plan_samrad_p", 
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Samråd</div>" +
					"<div class='popup-text1'>Plannamn: ${plannamn}</div>" +
					"<div class='popup-text1'>plannr: ${dp_namn}</div>" +
					"<div class='popup-text1'>Anmäld: ${anmald_sbn}</div>"+
					"<div class='popup-text1'>Samråd: ${samrad}</div>"+
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_samrad_p&version=1.1.1&format=image/png&rule=6"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_samrad_p&version=1.1.1&format=image/png&rule=6"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			},
			{
				...
				name: "sbkplan_gransk",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sbkplan_gransk",
				category : ["PLANERA & BYGGA","Planera", "Pågående detaljplan"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?",
				params : {
					layers: "malmows:git_sbk_plan_granskning_p", 
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Granskning</div>" +
					"<div class='popup-text1'>Plannamn: ${plannamn}</div>" +
					"<div class='popup-text1'>plannr: ${dp_namn}</div>" +
					"<div class='popup-text1'>Anmäld: ${anmald_sbn}</div>"+
					"<div class='popup-text1'>Samråd: ${samrad}</div>"+
					"<div class='popup-text1'>Granskning: ${granskning}</div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/editPlan.aspx?id=${objectid}' target='_blank'>Visa mer information</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/allaplaner.aspx' target='_blank'>Visa plankatalogen</a></div>"+
					"<div class='popup-text1'><a href='${url}' target='_blank'>Visa plandokumentation</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${dp_easting};${dp_northing}' target='_blank'>Visa snedbild</a></div>",						
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_granskning_p&version=1.1.1&format=image/png&rule=6"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_granskning_p&version=1.1.1&format=image/png&rule=6"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			{
				displayName : 'Antagen/Godkänd',
				name: "sbkplan_godkand_antagen",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sbkplan_antagen",
				category : ["PLANERA & BYGGA","Planera", "Pågående detaljplan"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?",
				params : {
					layers: "malmows:git_sbk_plan_godkandsbn_antagen_p", 
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Antagen/Godkänd</div>" +
					"<div class='popup-text1'>Plannamn: ${plannamn}</div>" +
					"<div class='popup-text1'>plannr: ${dp_namn}</div>" +
					"<div class='popup-text1'>Anmäld: ${anmald_sbn}</div>"+
					"<div class='popup-text1'>Samråd: ${samrad}</div>"+
					"<div class='popup-text1'>Granskning: ${granskning}</div>"+
					"<div class='popup-text1'>Antagen: ${antagen_sbn}</div>"+
					"<div class='popup-text1'>Godkänd SBN: ${godkand_sbn}</div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/editPlan.aspx?id=${objectid}' target='_blank'>Visa mer information</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkplan/allaplaner.aspx' target='_blank'>Visa plankatalogen</a></div>"+
					"<div class='popup-text1'><a href='${url}' target='_blank'>Visa plandokumentation</a></div>"+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${dp_easting};${dp_northing}' target='_blank'>Visa snedbild</a></div>",						
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_godkandsbn_antagen_p&version=1.1.1&format=image/png&rule=6"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_godkandsbn_antagen_p&version=1.1.1&format=image/png&rule=6"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			},				
			{
				...
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_fastighetsplaner_p",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/planera/fastighetsplanerhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/planera/fastighetsplaner.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "sma_planomr_p",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/planera/planer.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_planomr_p",
				category : ["PLANERA & BYGGA","Planera", "Detaljplaner"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				popup :
					...
					"<div class='popup-text1'><a href='http://kartor.malmo.se/asp/Planer/Planer_lmv.asp?PLAN=${plan_international}' target='_blank'>${plan}, Läs mer...</a></div>",
					//"<br>" +
					//"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</div>",
					selectable : true, getFeatureInfo: {geometryName: "geom"},
				geomType : 'area',
				startVisible : false,
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/planera/planerhoover.png"
					}
				},
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/planera/planer.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/planera/planer.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_bestammelse_dp",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/planera/Bestammelserdetaljplanhoover.png"
					}
				},
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/planera/Bestammelserdetaljplan.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
	...
	/* Ersätts av lager ovan, Ta bort dessa om allt funkar		{
				displayName : 'Pågående detaljplan',
				name: "sma_pagaende_plan_p",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/planera/pagaendeplaner.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_pagaende_plan_p",
				category : ["PLANERA & BYGGA","Planera"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${plan}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/planera/pagaendeplanerhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/planera/pagaendeplaner.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_pagaende_planprogram_p",
				category : ["PLANERA & BYGGA","Planera"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?",
				selectAttributes: ["${plan}"],
...
/*			
			{
				...
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=oversiktsplan_2005",
				category : ["PLANERA & BYGGA","Planera"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/planera/oversiktsplanhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/planera/oversiktsplan.png"}
				}
			},							
...
*/
			{
				...
				name: "fixpunkt",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/stomnat/Fixpunkt.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=fixpunkt",
				...
				popup :
					...
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/punktDB/stomnat.aspx?pnr=${punktnamn}' target='_blank'>Visa punktinformation</a></div>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${e};${n}' target='_blank'>Visa snedbild</a></div>" +
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/stomnat/fixpunkthoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/stomnat/fixpunkt.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
								filter: new OpenLayers.Filter.Comparison({
						...
						
			{
				...
				name: "polygonpunkt",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/stomnat/Polygonpunkt.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=polygonpunkt",
				category : ["PLANERA & BYGGA","Bygga"],
				displayInLayerSwitcher: true,
				URL: 'http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?',
				...
				report: {
					IDattribute: "punktnamn",
					linkURL: "http://sbkvmas2.sbkmalmo.local/git/select/select.aspx?layer=polygonpunkt&object="
				},
				params : {
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/stomnat/polygonpunkthoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/stomnat/polygonpunkt.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			{
				displayName : 'Exploateringsområden',
				name: "fk_exploateringsomraden",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Bygga/exploateringsomraden.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=fk_exploateringsomraden_p",
				category : ["PLANERA & BYGGA","Bygga"],
				displayInLayerSwitcher: true,
				...
				params : {
					...
					layers: "fkkartan:FKVY_EXPLOMRADE",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Exploateringsområden</div>" +
					"<div class='popup-text1'>Text: ${Text}</div>" +
					"<div class='popup-text1'>Typ: ${Typ}</div>" +
					//"<div class='popup-text1'>Projekttyp: ${Typ}</div>" +
				...
				legend : {
					hover: {
						url: "http://sbkvmas2.malmo.se/git/metadata/legender/fk_exploateringsomraden.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmas2.malmo.se/git/metadata/legender/fk_exploateringsomraden_mini.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			// {
				...
				// layerType : "wms",
				// //dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Bygga/exploateringsomraden.html",
				// dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=fk_exploateringsomraden_p_verksamheter",
				// category : ["PLANERA & BYGGA","Bygga"],
				// displayInLayerSwitcher: true,
				// URL: "http://fkmap.malmo.se/wms?",
				// //URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				// legend : {
					// hover: {
						// url: "http://sbkvmgeoserver.malmo.se/Bilder/Bygga/exploateringverksamheterhoover.png"
					// }
				// },		
				// copyright : [],
				// style: {
					// "default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Bygga/exploateringverksamheter.png"},
					// "select": {
						// rules: [
						        // new OpenLayers.Rule({
						        	// filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Bygga/exploateringsomraden.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=malmo_sma_fk_mbps_p",
				category : ["PLANERA & BYGGA","Bygga"],
				displayInLayerSwitcher: true,
				URL: "http://fkmap.malmo.se/wms?",
				//URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
	...
	popup :
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Bygga/miljobyggprogramsydhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Bygga/miljobyggprogramsyd.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			// {
				...
				// layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Bygga/miljobyggprogramsyd.html",
				// dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=malmo_sma_fk_mbps_p",
				// category : ["PLANERA & BYGGA","Bygga"],
				// displayInLayerSwitcher: true,
				// URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
...
/* 			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Bygga/nybyggnadskarta.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_nybyggnadskarta_pt",
				category : ["PLANERA & BYGGA","Bygga"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				popup :
					...
					"<br>" +
					"<a class='popup-text1' href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</a><br>" +
					"<div class='popup-text1'><a href='http://sbkvmgeoserver.malmo.se/cyclomedia/index.html?posx=${easting}&posy=${northing}' target='_blank'>Visa gatuvy</div>",
				selectable : true, getFeatureInfo: {geometryName: "geom"},
				geomType : 'area',
				startVisible : false,
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Bygga/nybyggnadskartahoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Bygga/nybyggnadskarta.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	symbolizer: {
			...
			}, */
			{
				...
				popup :				
					...
					"<a class='popup-text1'>Avslutad: ${avslutad}</a><br>" +
					"<br>" +
					"<a class='popup-text1' href='http://sbkvmas2.sbkmalmo.local/git/nbk/nbkspara.aspx?id=${id}' target='_blank'>Visa nbk-information</a><br>" +
					"<br>" +
					"<a class='popup-text1' href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</a><br>" +
					"<div class='popup-text1'><a href='http://sbkvmgeoserver.malmo.se/cyclomedia/index.html?posx=${easting}&posy=${northing}' target='_blank'>Visa gatuvy</div>",
				selectable : true, 
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:SMA_TELLUS2_NYBYGGKARTOR_AVS_PT&version=1.1.1&format=image/png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:SMA_TELLUS2_NYBYGGKARTOR_AVS_PT&version=1.1.1&format=image/png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	symbolizer: {
			...
			},
			{
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:SMA_TELLUS2_NYBYGGKARTOR_PG_PT&version=1.1.1&format=image/png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:SMA_TELLUS2_NYBYGGKARTOR_PG_PT&version=1.1.1&format=image/png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	symbolizer: {
				...
				
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Förvalta/markinnehav.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_sum_fastyta_markinnehav_p",
				...
				popup :
					...
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/asp/fir/fir_sok.asp?FNR=${fnr}' target='_blank'>Visa fastighetsinformation</div>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</div>",
				selectable : true, getFeatureInfo: {geometryName: "geom"},
				geomType : 'area',
				startVisible : false,
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Förvalta/markinnehavhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Förvalta/markinnehav.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Bygga/exploateringsomraden.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=skotselansvar_stadsfast",
				category : ["PLANERA & BYGGA","Förvalta"],
				displayInLayerSwitcher: true,
				URL: "http://fkmap.malmo.se/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Förvalta/skotselansvarfkhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Förvalta/skotselansvarfk.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Bygga/exploateringsomraden.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=skotselansvar_hamnen",
				category : ["PLANERA & BYGGA","Förvalta"],
				displayInLayerSwitcher: true,
				URL: "http://fkmap.malmo.se/wms?",
				//URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Förvalta/skotselansvarhamnhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Förvalta/skotselansvarhamn.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			// {
				...
				// layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Förvalta/skotselansvar.html",
				// dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=malmo_sma_fk_skotselansvar_p",
				// category : ["PLANERA & BYGGA","Förvalta"],
				// displayInLayerSwitcher: true,
				// URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				// legend : {
					// hover: {
						// url: "http://sbkvmgeoserver.malmo.se/Bilder/Förvalta/skotselansvarhoover.png"
					// }
				// },		
				// copyright : [],
				// style: {
					// "default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Förvalta/skotselansvar2.png"},
					// "select": {
						// rules: [
						        // new OpenLayers.Rule({
						        	// filter: new OpenLayers.Filter.Comparison({
						...
						
			{
				...
				name: "bygglovbostad",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/statistikmetadata.aspx?id=bygglovbostad&img=http://sbkvmgeoserver.malmo.se/Bilder/Bostadsbyggnadsregister/BLbostad.png",
				category : ["PLANERA & BYGGA","Bostadsbyggnadsregister"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${objectid}"],
					
				params : {
					layers: "malmows:git_sbk_plan_bostad_bygglov_pt",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					...
					"<div class='popup-text1'>Diarienummer: ${dnr_by}</div>" +
					"<div class='popup-text1'>Detaljplan: ${dp_namn}</div>" +
					"<div class='popup-text1'>Fastighetsbeteckning: ${fast}</div>" +
					"<div class='popup-text1'>Sökande: ${sokande}</div>" +
					"<div class='popup-text1'>Bygglov beviljas: ${by_beslut}</div>" +
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkbygglov/editBygglov.aspx?id=${objectid}' target='_blank'>Visa mer information</div>" +
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkbygglov/allabygglov.aspx' target='_blank'>Visa bostadsbyggnadsregister</div>" +
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</div>" +
					"<div class='popup-text1'><a href='http://sbkvmgeoserver.malmo.se/cyclomedia/index.html?posx=${easting}&posy=${northing}' target='_blank'>Visa gatuvy</div>",
				selectable : true, getFeatureInfo: {geometryName: "geom"},
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_bostad_bygglov_pt&version=1.1.1&format=image/png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_bostad_bygglov_pt&version=1.1.1&format=image/png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			{
				displayName : 'Startbesked bostad',
				name: "bygglovbostadstartbesk",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/statistikmetadata.aspx?id=bygglovbostadstartbesk&img=http://sbkvmgeoserver.malmo.se/Bilder/Bostadsbyggnadsregister/BLstartbesked.png",
				category : ["PLANERA & BYGGA","Bostadsbyggnadsregister"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${objectid}"],
				...
				params : {
					layers: "malmows:git_sbk_plan_bostad_startbesk_pt",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Startbesked bostad</div>" +
					"<div class='popup-text1'>Diarienummer: ${dnr_by}</div>" +
					"<div class='popup-text1'>Detaljplan: ${dp_namn}</div>" +
					"<div class='popup-text1'>Fastighetsbeteckning: ${fast}</div>" +
					"<div class='popup-text1'>Sökande: ${sokande}</div>" +
					"<div class='popup-text1'>Bygglov beviljas: ${by_beslut}</div>" +
					"<div class='popup-text1'>Startbesked/kontrollplan: ${kontrollplan}</div>" +
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkbygglov/editBygglov.aspx?id=${objectid}' target='_blank'>Visa mer information</div>" +
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/sbkbygglov/allabygglov.aspx' target='_blank'>Visa bostadsbyggnadsregister</div>" +
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_bostad_startbesk_pt&version=1.1.1&format=image/png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_bostad_startbesk_pt&version=1.1.1&format=image/png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			{
				displayName : 'Byggstart bostad',
				name: "bygglovbostadbyggstart",
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/statistikmetadata.aspx?id=bygglovbostadbyggstart&img=http://sbkvmgeoserver.malmo.se/Bilder/Bostadsbyggnadsregister/BLbyggstart.png",
				category : ["PLANERA & BYGGA","Bostadsbyggnadsregister"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${objectid}"],
				...
				params : {
					layers: "malmows:git_sbk_plan_bostad_byggstart_pt",
					format: "image/png",
					transparent: "true"
				}, 
				options : {
				...
				popup :
					"<div class='popup-header1'>Byggstart bostad</div>" +
					"<div class='popup-text1'>Diarienummer: ${dnr_by}</div>" +
					"<div class='popup-text1'>Detaljplan: ${dp_namn}</div>" +
					"<div class='popup-text1'>Fastighetsbeteckning: ${fast}</div>" +
					"<div class='popup-text1'>Sökande: ${sokande}</div>" +
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_bostad_byggstart_pt&version=1.1.1&format=image/png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.sbkmalmo.local/geoserver/malmows/wms?request=GetLegendGraphic&layer=malmows:git_sbk_plan_bostad_byggstart_pt&version=1.1.1&format=image/png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
		...
		
			{
				...
				name: "byar",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/byinventering/byar.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=byar",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Byinventering/byarhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Byinventering/byar.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "inventering",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/byinventering/inventering.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=inventering",
				category : ["PLANERA & BYGGA","Byinventering"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				popup :
					...
					"<br>" +
					"<div class='popup-text1'><a href='http://kartor.malmo.se/byinventering/default.aspx?mID=${koord_id}' target='_blank'>Visa foto och information</div>" +
					"<br>" +
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</div>" +
					"<div class='popup-text1'><a href='http://sbkvmgeoserver.malmo.se/cyclomedia/index.html?posx=${easting}&posy=${northing}' target='_blank'>Visa gatuvy</div>",
					selectable : true, getFeatureInfo: {geometryName: "geom"},
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Byinventering/inventeringhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Byinventering/inventering.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/byinventering/landskapskaraktar.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=landskapskarakt",
				category : ["PLANERA & BYGGA","Byinventering"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Byinventering/landskapskaraktarerhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Byinventering/landskapskaraktarer.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "socknar",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/byinventering/socknar.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=socknar",
				category : ["PLANERA & BYGGA","Byinventering"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Byinventering/socknarhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Byinventering/socknar.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			},
			{
				...
				name: "planfsk",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/skola/forskola.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=planfsk",
				category : ["SKOLA"],
				displayInLayerSwitcher: true,
				URL: 'http://kartor.malmo.se/geoserver/wms?',	
				selectAttributes: ["${namn}"],
				...
				legend : {
					hover: {
						url: "http://kartor.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:POI_PLANERADE_FORSKOLOR_PT&version=1.1.1&format=image/png&rule=1"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://kartor.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:POI_PLANERADE_FORSKOLOR_PT&version=1.1.1&format=image/png&rule=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
						        	...
						        	// if a feature matches the above filter, use this style
						        	symbolizer: {
								    	externalGraphic: 'http://sbkvmgeoserver.malmo.se/bilder/Generell_select/kvadrat_stor_turkos.png'
							        }
						        }),
						        new OpenLayers.Rule({
						        	elseFilter: true,
			...
			},
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/skola/forskola.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=forskola",
				category : ["SKOLA"],
				displayInLayerSwitcher: true,
				URL: 'http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?',	
				selectAttributes: ["${namn}"],
				...
				popup :
					...
					"<div class='popup-text1'>${namn}</div>" +
					"<div class='popup-text1'><a href='${function(p){if(p.url && p.url.length >= 4 && p.url.substring(0,4).toUpperCase() === \'HTTP\') {return p.url} else{return \'http://\' + p.url}  }}'  target='_blank'>${plan} Läs mer</a></div>" +
					"<br>" +
					"<div class='popup-text1'>Stadsområde: ${stadsomr}</div>" +
					"<div class='popup-text1'>Delområde: ${delomr}</div>" +
					"<br>" +
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_FORSKOLOR_KOMMUNAL_PT&version=1.1.1&format=image/png&rule=1"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_FORSKOLOR_KOMMUNAL_PT&version=1.1.1&format=image/png&rule=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			 {
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_FORSKOLOR_PRIVAT_PT&version=1.1.1&format=image/png&rule=1"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_FORSKOLOR_PRIVAT_PT&version=1.1.1&format=image/png&rule=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...

			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/skola/forskola.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/statistikmetadata.aspx?id=oppen_forskola&img=http://sbkvmgeoserver.malmo.se/bilder/skola/forskola_oppen.png",
				category : ["SKOLA"],
				displayInLayerSwitcher: true,
				URL: 'http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?',	
				selectAttributes: ["${namn}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_FORSKOLOR_OPPEN_PT&version=1.1.1&format=image/png&rule=1"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_FORSKOLOR_OPPEN_PT&version=1.1.1&format=image/png&rule=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			}, 
			{
				...
				name: "grundskola_kommunal",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/skola/grundskola.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=grundskola",
				category : ["SKOLA"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/wms?",
				selectAttributes: ["${id}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_GRUNDSKOLA_KOMMUNAL_PT&version=1.1.1&format=image/png&rule=1"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_GRUNDSKOLA_KOMMUNAL_PT&version=1.1.1&format=image/png&rule=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	symbolizer: {
			 ...
			 
			{
				...
				popup :
					...
					"<div class='popup-text1'>${ort}</div>" +
					"<br>" +
					'${function(p){if (p.url && p.url.length >= 4 && p.url.substring(0, 4).toUpperCase() === \"HTTP\") {return \"<div class=\'popup-text1\'><a href=\'\"+p.url+\"\' target=\'_blank\'>Läs mer</a></div>\"} else {return ""} }}'+
					"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</div>" +
					"<div class='popup-text1'><a href='http://sbkvmgeoserver.malmo.se/cyclomedia/index.html?posx=${easting}&posy=${northing}' target='_blank'>Visa gatuvy</div>",
				selectable : true,
				getFeatureInfo: {geometryName: "geom"},
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_GRUNDSKOLA_FRISTAENDE_PT&version=1.1.1&format=image/png&scale=1"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_GRUNDSKOLA_FRISTAENDE_PT&version=1.1.1&format=image/png&scale=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	symbolizer: {
			...
			},
			{
				...
				name: "grundsarskola_kommunal",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/skola/grundskola.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=grundsarskola",
				category : ["SKOLA"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/wms?",
				selectAttributes: ["${id}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_GRUNDSKOLA_SARSKOLA_KOMMUNAL_PT&version=1.1.1&format=image/png&scale=1"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_GRUNDSKOLA_SARSKOLA_KOMMUNAL_PT&version=1.1.1&format=image/png&scale=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	symbolizer: {
			...
			},
			{
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_GRUNDSKOLA_SARSKOLA_FRISTAENDE_PT&version=1.1.1&format=image/png&scale=1"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/geoserver/wms?request=GetLegendGraphic&layer=malmows:V_POI_EXTENS_GRUNDSKOLA_SARSKOLA_FRISTAENDE_PT&version=1.1.1&format=image/png&scale=1"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	symbolizer: {
			...
			},
			{
				...
				name: "gymnasieskola",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/skola/gymnasieskola.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=gymnasieskola",
				category : ["SKOLA"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",	
				selectAttributes: ["${objektnamn}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/skola/gymnasieskolahoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/skola/gymnasieskola.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/skola/hogskola.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hogskolaochuniversitet",
				category : ["SKOLA"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",	
				selectAttributes: ["${objektnamn}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/skola/hogskolahoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/skola/hogskola.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "ovrigskola",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/skola/ovrigskola.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=ovrigskola",
				category : ["SKOLA"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",	
				selectAttributes: ["${objektnamn}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/skola/ovrigskolahoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/skola/ovrigskola.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "busstation",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/kommunikation/Busstation.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=busstation",
				category : ["TRAFIK"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${objektnamn}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/kommunikation/busstationhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/kommunikation/busstationNY.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	symbolizer: {
			...
			
			{
				...
				name: "busshallplats",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/kommunikation/Busshallsplats.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=busshallplats",
				category : ["TRAFIK"],
				displayInLayerSwitcher: true,
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/kommunikation/busshallsplatshoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/kommunikation/busshallsplats.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "cykelvag",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/kommunikation/cykelvag.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=cykelvag",
				category : ["TRAFIK"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				params : {
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/kommunikation/cykelvaghoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/kommunikation/cykelvag.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				name: "tagstation",
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/kommunikation/Tagstation.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=tagstation",
				category : ["TRAFIK"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${objektnamn}"],
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/Kommunikation/tagstationhoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/Kommunikation/tagstationNY.png"},
				"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
...
*/			
									...
									
			{
				...
				category : ["ÖVERSIKTSPLAN FÖR MALMÖ","Planeringsriktlinjer","Särskilda geografiska områden","Välj alla områden"],
				displayInLayerSwitcher: true,
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
			...
			},	
{
			...
			
			{
				...
				layerType : "wms",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_arkiv_bladindelning_2000",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Arkiv/bladindelning2000_hoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Arkiv/bladindelning2000.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Baskarta/fastigheter_arkiv_2010_12_20.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_arkiv_fastigheter_2010_12_20_p",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/Bilder/Baskarta/fastigheter_arkiv_hoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/Bilder/Baskarta/fastigheter_arkiv.png"},
					"select": {
						rules: [
						        new OpenLayers.Rule({
						        	filter: new OpenLayers.Filter.Comparison({
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Baskarta/fastigheter_arkiv_2005_12_13.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_arkiv_fastigheter_2005_12_13_p",
				category : ["ARKIV", "Fastighet"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${fastighet}"],
			...
			
			{
				...
				layerType : "wms",
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/Baskarta/fastigheter_arkiv_2001_10_09.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=sma_arkiv_fastigheter_2001_10_09",
				category : ["ARKIV", "Fastighet"],
				displayInLayerSwitcher: true,
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				selectAttributes: ["${fastighet}"],
...

			{
				...
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/baskarta/fotokarta_2011.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=ol_fotokarta_2012",
				...
				legend : {
					hover: {
						url: "http://sbkvmgeoserver.malmo.se/bilder/baskarta/fotokarta_hoover.png"
					}
				},		
				copyright : [],
				style: {
					"default": {externalGraphic: "http://sbkvmgeoserver.malmo.se/bilder/baskarta/fotokarta.png"}
				}
			},

			{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1757_malmo",
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1757.png"}
				}
		},
...

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1811_fornyad_plan",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1811_fornyad_plan.PNG"}
				}
		},

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1812_rek_kartan",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1812_rek_kartan.PNG"}
				}
		},
		
		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1853_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1853_malmo.PNG"}
				}
		},
		...
		
			{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1860_talet_plan_utvidgning",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1860_talet.png"}
				}
		},

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1871_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1871_malmo.png"}
				}
		},		
		
		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1875_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1875_malmo.png"}
				}
		},
		
		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1878_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1878_malmo.png"}
				}
		},				

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1897_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1897_malmo.png"}
				}
		},				

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1897_forslag_slottsparken",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1897_forslag_slottsparken.png"}
				}
		},				

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1903_forslag_stadsplan",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1903_forslag_stadsplan.png"}
				}
		},				

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1912_haradskartan",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1912_haradskartan.PNG"}
				}
		},			
...

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1914_pharus_plan",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1914_pharus_plan.png"}
				}
		},			
		
		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1913_oversiktsplan",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1913_oversiktsplan.PNG"}
				}
		},			

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1917_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1917_malmo.PNG"}
				}
		},
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1926_bulltofta",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1926_bulltofta.png"}
				}
		},				

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1931_sparvagar",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1931_sparvagar.PNG"}
				}
		},				
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1947_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1947_malmo.PNG"}
				}
		},			

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_1974_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_1974_malmo.PNG"}
				}
		},			

		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_2000_stadsbuss",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_2000_buss.PNG"}
				}
		},			
		...
		
		{
				...
				layerType : "wms",
				displayInLayerSwitcher: true,
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=hist_karta_2004_malmo",
				category : ["ARKIV", "Karta"],
				URL: "http://kartor.malmo.se/geoserver/wms?",
				params : {
				...
				style: {
					"default": {externalGraphic: "http://sbkvmas2.sbkmalmo.local/git/metadata/legender/hist_karta_2004_malmo.png"}
				}
		},
			...
			
			{
				...
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/baskarta/fotokarta_2011.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=ol_fotokarta_2011",
				category : ["ARKIV", "Fotokarta"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
			...
			
			{
				...
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/baskarta/fotokarta_2010.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=ol_fotokarta_2010",
				category : ["ARKIV", "Fotokarta"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
			...
			
			{
				...
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/baskarta/fotokarta_2007.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=ol_fotokarta_2007",
				category : ["ARKIV", "Fotokarta"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
			...
			
			{
				...
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/baskarta/fotokarta_2004.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=ol_fotokarta_2004",
				category : ["ARKIV", "Fotokarta"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
			...
			
			{
				...
				dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/baskarta/fotokarta_2001.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=ol_fotokarta_2001",
				category : ["ARKIV", "Fotokarta"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
			...
			
			{
				...
				//dialogContent: "http://sbkvmgeoserver.malmo.se/metadata/baskarta/fotokarta_1998.html",
				dialogContent: "http://sbkvmas2.sbkmalmo.local/git/metadata/metadata.aspx?id=ol_fotokarta_1998",
				category : ["ARKIV", "Fotokarta"],
				displayInLayerSwitcher: true,
				//tooltip: "Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum Lorem lopsum",
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
...
/*					
		{
				displayName : 'Stadskarta',  //går mot kartor.malmo.se  AGS
				name: "stadskartan",
				layerType : "wms",
				category : "Karta",
...
*/
			...
			{
				displayName : "Stadskarta",  //går mot sbkvmgeoserver.malmo.se tilecache.org
				name : "stadskartan",  
				URL: document.location.protocol + "//sbkvmgeoserver.malmo.se/tilecache/malmo/",
				layer : "pbatlas_2015_4",
				layerType : "tilecache",
				category : "Karta",
				options : {
					resolutions : [67.733504,50.800128,33.866752,25.400064,16.933376,12.700032,8.466688,4.233344,2.116672,1.058336,0.529168,0.26458483], 
					...
					attribution : "<a href='mailto:stadsatlas@malmo.se?subject=Stadsatlas'>© Stadsbyggnadskontoret, Malmö stad</a>",
					splitLayer: {
						name: "stadskartan_splitlayer",
						layerType : "wms",
						URL: "http://kartor.malmo.se/arcgis/services/atlaskarta_ggb_wms/MapServer/WMSServer",
						params : {
							layers: "0",
							format: "image/png",
							transparent: "true",
						...
						options : {
							splitRange: [7, 15], // custom property where split layer is visible and parent layer is not
							maxExtent: new OpenLayers.Bounds(97000,6148000,139000,6175000),
							resolutions : [67.733504,50.800128,33.866752,25.400064,16.933376,12.700032,8.466688,4.233344,2.116672,1.058336,0.529168,0.26458483], 
							isBaseLayer: true,
							//opacity: "0.85",
...
*/
			...
			/*
			{
				displayName : "Stadskarta",
				name : "stadskartan",  // ska ej vara årtal på "name", om vi har med årtal kommer gamla länkar inte funka om vi byter till nytt ortofoto
				 URL: "http://sbkvmgeoserver/geoserver/gwc/service/tms/",
				 layerType : "TMS",
				 category : "Karta",
				 options : {
...
*/	
		...
		{
				displayName : 'Malmö 2015',
				name: "malmo_orto_2015",
				layerType : "wms",
				category : "Fotokarta",
				URL: "http://sbkvmgeoserver.malmo.se/geoserver/malmows/wms?",
				params : {
		...
		
		{
				...
				params : {
					layers: "malmows:malmo_orto_2014",  //senaste orto ska heta malmo_orto 
					format: "image/jpeg",
					transparent: "true"
				}, 
				options : {
...
//			 displayName : "Ulf TMS",
//			 name : "ulf_tms",
//			 URL: "http://sbkvmgeoserver.malmo.se/geoserver/gwc/service/tms/",
//			 layerType : "TMS",
//			 category : "Karta",
//			 options : {
...
//			 name : "ulf_wmts",
//			 url: "http://sbkvmgeoserver.malmo.se/geoserver/gwc/service/wmts/",
//			 layerType : "WMTS",
//			 category : "Karta",
//			 options : {
//					layername: "malmows:SMA_ARKIV_FASTIGHETER_2005_12_13_P",
	...
	[
		...
		},
		{
			...
			config: {
				displayName: "Hjälp",
				toolbarIndex: 1,
				content: "http://sbkvmgeoserver.malmo.se/dokument/hjalp/hjalp.htm",
				dialog: {
					title: "Hjälp",
					width: "720",
					height: "600",
		...
		},
		{
			...
			config : {
				...
				autoCompleteScriptUrl : "http://sbkvmas2.sbkmalmo.local/git/api/v1/addresses/autocomplete/?",
				searchScriptUrl : "http://sbkvmas2.sbkmalmo.local/git/api/v1/addresses/geolocate/",
				displayName : "Sökning",
				encSpace: "%2b",
				poiLayer: {
					popup: "<div class='popup-header1'>${name}</div>" +
						"<a class='popup-text1' href='${function(p){if(p.url && p.url.length >= 4 && p.url.substring(0,4).toUpperCase() === \'HTTP\') {return p.url} else{return \'http://\' + p.url}  }}'  target='_blank'>${plan} Visa information</a><br>" +
						"<div class='popup-text1'><a href='http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${easting};${northing}' target='_blank'>Visa snedbild</div></a>" +
...
//				btnHover: "Verktyg för att se gatuvy",
...

		{
			...
			config : {
				...
				addToToolsMenu: "adv",
				url: "http://sbkvmas2.sbkmalmo.local/git/urbex/index.htm?p=true&xy=${x};${y}",
...
*/
		{
			...
			config : {
				...
				addToToolsMenu: "simple",
				url: "http://sbkvmas2.sbkmalmo.local/git/nbk/nbkinsert.aspx?easting=${x}&northing=${y}",
		...
		},
		{
			...
			config : {
				...
				addToToolsMenu: "simple",
				url: "http://sbkvmas2.sbkmalmo.local/git/sbkplan/editPlan.aspx?easting=${x}&northing=${y}",
		...
		},
		{
			init : sMap.Module.RedirectClick,			
			config : {
				displayName : 'Registrering BoBy',
				addToToolsMenu: "simple",
				url: "http://sbkvmas2.sbkmalmo.local/git/sbkbygglov/editBygglov.aspx?e=${x}&n=${y}",
				buttonId: "redirect-boby",
				buttonCss: "ui-icon-pencil",
				mouseMoveText: "Klicka i kartan för att registrera bygglov för bostad"
			}
		},
...
*/
		...
		// 			width: 140,
		// 			height: 350,
		// 			cookieName: 'smap_introdialog_crisis_dontshowagain',
		// 			cookieExpiresDays: 3
		// 		},
		// 		contentHtml: 
		// 			'<h1 style="color:red; margin: 0"><strong>DRIFTSTÖRNING</strong></h1>'+
		// 			'<p>På grund av tekniska problem är atlasens funktion begränsad just nu.</p>'+
		// 			'<p>Sökfunktionen och de flesta lager fungerar, bland annat fastigheter, detaljplaner och den senaste fotokartan. <a href="http://sbkvmgeoserver.malmo.se/init/html/pbatlas/crisis">Läs mer här...</a></p>'+
		// 			'<p>Vi arbetar för att problemet ska vara löst så snart som möjligt. När vi har mer information kommer denna ruta uppdateras.</p>'
		// 	}
		// }
		...
		,
		 {
		 	...
		 	config: {
		 		dialogOptions: {
		 			...
		 			width: 160,
		 			height: 410,
		 			cookieName: 'smap_introdialog_crisis_dontshowagain_andagain_7',
		 			cookieExpiresDays: 3
		 		},
		 		contentHtml: 
		 			'<h1 style="color:red; margin: 0"><strong>DRIFTSTÖRNING</strong></h1>'+
		 			'<p>Atlasens funktion är begränsad fredagen den 22/1 från kl 13.30 till ca 14.00. <a target="_blank" href="https://webapps04.malmo.se/nyheter/2016/01/21/servicefonster-kartor-malmo-se-21-januari-1700-2030/">Läs mer här...</a></p>'+
		 			'<p>Sökfunktionen och de flesta lager fungerar, bland annat fastigheter, detaljplaner och den senaste fotokartan.  </p>'+
					"<br><p>Obs! data i Fastighetsinformationsregistret (FIR) är ej uppdaterat sedan 2015-12-31. Detta påverkar fastighetsinformation men även uppdatering av labels på fastigheter i kartan. Uppdatering sker vecka 3. </p>"
		...
		,
			...
			config: {
				dialogOptions: {
					...
					width: 195,
					height: 290,
					cookieName: 'smap_introdialog_5',
		 			cookieExpiresDays: 3
				},
				contentHtml: 
					//"<p>Obs! data i Fastighetsinformationsregistret (FIR) är ej uppdaterat sedan 2016-01-05. Detta påverkar fastighetsinformation men även uppdatering av labels på fastigheter i kartan."+
					"<p>Det är problem med FIR och ByggR. IT har felanmält till företaget som de köpt dessa programmen av och hoppas på snar rättning"+
					"<p>Plan och Byggatlas<br>Välkommen!</p>"+
					"<p>Nytt lager (inlagt i atlasen i februari 2016): Ideal traktindelning. Finns under Fastighetskarta respektive Primärkarta</p>"+
					"<p>Internet Explorer 9,10,11, Google Chrome, Firefox rekommenderas</p>"
...
/*if (navigator.userAgent.search(/mac/gi) !== -1) {
	...
	for (var i=0,len=ls.length; i<len; i++) {
		t = ls[i];
		if (t.URL)
			t.URL = t.URL.replace("sbkvmgeoserver", "sbkvmgeoserver.malmo.se");
	}	
}*/
