...
sMap.Module.Unselect = OpenLayers.Class(sMap.Module, {
	 ...
	 */
	EVENT_TRIGGERS : ["addtoolbutton","unselect"],
	
	initialize : function(options) {
		options = options || {};
		
		this.EVENT_LISTENERS =
			sMap.Module.Unselect.prototype.EVENT_LISTENERS.concat(
				sMap.Module.prototype.EVENT_LISTENERS
        );
		this.EVENT_TRIGGERS =
			sMap.Module.Unselect.prototype.EVENT_TRIGGERS.concat(
	...
	activate : function() {
		...
		$('#button-unselect').removeClass('ui-state-focus');
	...
	drawContent : function() {
		sMap.events.triggerEvent("addtoolbutton", this, {
			...
			iconCSS : "ui-icon-cancel", 
			tagID : "button-unselect"
		});
	}, 
	
	// Class name needed when you want to fetch your module...
	// should correspond to the real class name.
	CLASS_NAME : "sMap.Module.Unselect"
